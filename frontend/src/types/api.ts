...
export interface ResearchSignalComparisonItem {
  key: string;
  label: string;
...
export interface ResearchSignalPatternComparisonItem {
  key: string;
  label: string;
  pre_401_count: number;
  pre_401_rate: number;
...
export interface ResearchCurrentSignalGroupBreakdownItem {
  ...
  top_historical_gap_bucket: string | null;
  top_historical_gap_label: string | null;
  top_historical_gap_count: number;
